...
namespace FRS
{
    public partial class registration : System.Web.UI.Page
    {
        ...
        protected void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            string scanp = ScanPhotoFileUpload.ClientID;
            string r = "";
            ...
            string res = reg.Saveregistration(fn, ln, add, cnum, em, g, pass, cpass, dob, dojoin, id, idnum, scanp,r);
            ...
            /* string res1 = reg.checkemailid(em);
             ...
             {
                 StatusLabel.Text = "User with this email id already exists, please use some other emailid";
                 EmailTextBox.Text = "";
                 EmailTextBox.Focus();
