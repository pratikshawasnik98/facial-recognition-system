...
namespace registration
{
    public class Register
    {
        ...
        public string checkemailid(string em)
        {
            ...
            {
                con.Open();
                string qr = "select count(*) from registerDB where emailid='" + em + "'";
    ...
    */
        ...
        public string Saveregistration(string f, string l, string add, string mob, string e, string gen, string pass, string cpass, string dob, string doj, string id, string idnum, string sp,string r)
        {
